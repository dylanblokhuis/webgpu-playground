  ...
  return (
    <div className='w-full h-[58%] bg-slate-900  text-white font-mono flex flex-col overflow-hidden'>
      <div className='flex items-center border-b border-t border-slate-700 px-3 py-2 '>
        ...
        <span className={clsx('min-w-6 h-6 px-2  rounded-full flex items-center justify-center', logs.filter(l => l.type === "error").length > 0 ? "bg-red-500" : "bg-slate-700")}>{logs.length}</span>
      </div>
